...
Anyone can contribute to **Diversity repo** on any of our communication channels.


**Every issue in this repository is seeking contribution**. Click on issues to find ways to contribute. See this [list of all issues](https://github.com/mozilla/diversity/issues).

### We need activists, enthusiasts, community input, and more… Anyone, with any skill set, can find a way to pitch in.

## Contributing to the Diversity Repo
